...
result = ["짝" if x % 2 == 0 else "홀" for x in range(1, 22)]
...
result = [
    i for i in words if "n" in i
]  # result[w for w in words if w.find("n") >= 0]도 가능
